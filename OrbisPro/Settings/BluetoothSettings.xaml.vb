...
#Region "Input"
    ...
    Private Sub ChangeButtonLayout()
        ...
        If SharedDeviceModel = DeviceModel.PC AndAlso MainController Is Nothing Then
            ...
            Action2Button.Source = New BitmapImage(New Uri("/Icons/Buttons/S_Key_Dark.png", UriKind.RelativeOrAbsolute))
        Else
            If Not String.IsNullOrEmpty(GamepadButtonLayout) Then
                Select Case GamepadButtonLayout
                    Case "PS3"
                        ...
                        Action2Button.Source = New BitmapImage(New Uri("/Icons/Buttons/PS3/PS3_Square.png", UriKind.RelativeOrAbsolute))
                    Case "PS4"
                        ...
                        Action2Button.Source = New BitmapImage(New Uri("/Icons/Buttons/PS4/PS4_Square.png", UriKind.RelativeOrAbsolute))
                    Case "PS5"
                        ...
                        Action2Button.Source = New BitmapImage(New Uri("/Icons/Buttons/PS5/PS5_Square.png", UriKind.RelativeOrAbsolute))
                    Case "PS Vita"
                        ...
                        Action2Button.Source = New BitmapImage(New Uri("/Icons/Buttons/PSV/Vita_Square.png", UriKind.RelativeOrAbsolute))
                    Case "Steam"
                        ...
                        Action2Button.Source = New BitmapImage(New Uri("/Icons/Buttons/Steam/Steam_X.png", UriKind.RelativeOrAbsolute))
                    Case "Steam Deck"
                        ...
                        Action2Button.Source = New BitmapImage(New Uri("/Icons/Buttons/SteamDeck/SteamDeck_X.png", UriKind.RelativeOrAbsolute))
                    Case "Xbox 360"
                        ...
                        Action2Button.Source = New BitmapImage(New Uri("/Icons/Buttons/Xbox360/360_X.png", UriKind.RelativeOrAbsolute))
                    Case "ROG Ally"
                        ...
                        Action2Button.Source = New BitmapImage(New Uri("/Icons/Buttons/ROGAlly/rog_x.png", UriKind.RelativeOrAbsolute))
                End Select
            End If
        End If
    End Sub
