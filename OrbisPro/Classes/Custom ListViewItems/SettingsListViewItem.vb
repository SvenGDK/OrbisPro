...
Public Class SettingsListViewItem
    ...
    Private _AssociatedConfigFile As String
    Private _ConfigToChange As String
    Private _ConfigSectionName As String
    ...
    Public Property AssociatedConfigFile As String
        Get
            Return _AssociatedConfigFile
        End Get
        Set
            _AssociatedConfigFile = Value
            NotifyPropertyChanged("AssociatedConfigFile")
        End Set
    End Property

    Public Property ConfigSectionName As String
        Get
            Return _ConfigSectionName
        End Get
        Set
            _ConfigSectionName = Value
            NotifyPropertyChanged("ConfigSectionName")
        End Set
    End Property

    Public Property ConfigToChange As String
        Get
            Return _ConfigToChange
        End Get
        Set
            _ConfigToChange = Value
            NotifyPropertyChanged("ConfigToChange")
        End Set
    End Property
